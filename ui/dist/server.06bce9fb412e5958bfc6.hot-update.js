...
app.use(express__WEBPACK_IMPORTED_MODULE_2___default.a.static("public"), function (req, res, next) {
  ...
  res.header("Access-Control-Allow-Origin", "http://localhost:8000/issues"); // update to match the domain you will make the request from
...
//# sourceMappingURL=server.06bce9fb412e5958bfc6.hot-update.js.map