...
class IssueList extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  async loadData() {
    try {
      ...
      this.isLoadingScreen(data);
    } catch (err) {
      console.error(err);
    }
  }

  async isLoadingScreen(data) {
    (await data.loading) == true ? "loading..." : this.loadData();
  }
...
//# sourceMappingURL=server.8603ea0025d165f17b19.hot-update.js.map